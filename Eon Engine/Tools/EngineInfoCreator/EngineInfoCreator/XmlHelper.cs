...
namespace Eon.Helpers
{
    public sealed class XmlHelper
    {
        ...
        {
            using (FileStream stream = File.Open(filepath + fileExtention, System.IO.FileMode.Create))
            {
        ...
        {
            using (FileStream stream = File.Open(filepath, System.IO.FileMode.Create))
            {
