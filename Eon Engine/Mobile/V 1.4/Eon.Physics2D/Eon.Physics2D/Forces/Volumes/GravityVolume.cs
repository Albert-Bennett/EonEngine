...
namespace Eon.Physics2D.Forces.Volumes
{
    ...
    public class GravityVolume : PhysicsVolume
    {
        ...
        public GravityVolume(string id, Math.Shapes.Rectangle bounds,
        ...
        /// <param name="bounds">The bounds of the GravityVolume.</param>
        /// <param name="gravity">The intensity of the gravity.</param>
        public GravityVolume(string id, Math.Shapes.Rectangle bounds, float gravity) : this(id, bounds, gravity, new Vector2(0, 1)) { }
        ...
        /// <param name="id">The id of the GravityVolume.</param>
        /// <param name="bounds">The bounds of the GravityVolume.</param>
        public GravityVolume(string id, Math.Shapes.Rectangle bounds) : this(id, bounds, 9.8f, new Vector2(0, 1)) { }
