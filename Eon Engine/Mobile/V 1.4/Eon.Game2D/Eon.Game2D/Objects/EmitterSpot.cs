...
namespace Eon.Game2D.Objects
{
    ...
    public class EmitterSpot : GameObject, ILevelAsset
    {
        ...
        {
            particles = new ParticleSystem(ID + "ParticleSystem", particleSystemFilepath);
            particles.SetEmittionStartingPosition(position);
            particles.OnFinished += new OnFinishedEvent(Finished);
