...
namespace Eon
{
    ...
    public sealed class Common
    {
        ...
        /// <summary>
        /// The currently enabled screen orientations.
        /// </summary>
        /// <param name="landscape">Should the screen be orentated for landscape mode.</param>
        public static void EnabledScreenOrientationModes(bool landscape)
        {
            if (landscape)
            {
                Common.DeviceManager.SupportedOrientations =
                    DisplayOrientation.LandscapeLeft | DisplayOrientation.LandscapeRight;
            }
            else
                Common.DeviceManager.SupportedOrientations =
                    DisplayOrientation.Default | DisplayOrientation.Portrait;
        }
