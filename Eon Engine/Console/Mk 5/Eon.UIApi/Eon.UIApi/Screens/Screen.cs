...
namespace Eon.UIApi.Screens
{
    ...
    /// </summary>
    public abstract class Screen : GameObject, IHoldReferences
    {
        ...
        protected MenuItem CurrentControl
        {
            get
            {
                if (selectedIndex > -1 && controls != null)
        ...
        /// <summary>
        /// The number of controls attached to this.
        /// </summary>
        ...
        public void Remove(object obj)
        {
            if (obj is MenuItem)
            {
                MenuItem control = obj as MenuItem;

                if (control is IActive)
                    activatableControls.Remove(obj as IActive);
