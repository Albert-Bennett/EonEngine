...
namespace Eon.Particles.Attachments.Base
{
    ...
    public sealed class AttachmentPool
    {
        ...
        List<ParticlePropertySet> properties = new List<ParticlePropertySet>();

        internal List<ParticlePropertySet> Properties
        {
        ...
        internal ParticlePropertySet GeneratePropertySet()
        {
            ParticlePropertySet prop = new ParticlePropertySet();
