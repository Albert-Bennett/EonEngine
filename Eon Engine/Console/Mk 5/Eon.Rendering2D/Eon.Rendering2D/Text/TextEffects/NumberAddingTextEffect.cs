...
namespace Eon.Rendering2D.Text.TextEffects
{
    ...
    /// </summary>
    public sealed class NumberAddingTextEffect : TextItem
    {
        /// <summary>
        ...
        /// <summary>
        /// Include a comma after every 1000.
        /// </summary>
        public bool IncludeComma
        {
            get { return includeComma; }
            set { includeComma = value; }
        }
        ...
        void Generate()
        {
            ...
            if (currentTime >= changeRate)
            {
                ...
                currentTime -= changeRate;

                if (includeComma)
                    Text = currentNumber.ToString("N0");
                else
        ...
        /// </summary>
        /// <param name="minNumber">The new minimum number to be used.</param>
        ...
        /// <summary>
        /// Changes the maximum number used in the NumberAddingTextEffect.
        /// </summary>
        /// <param name="maxNumber">The new maximum number to be used.</param>
        ...
        /// <summary>
        /// Changes the number used in the NumberAddingTextEffect.
        /// </summary>
        /// <param name="maxNumber">The new number to be used.</param>
        ...
        /// <summary>
        /// Measures the actual size of the taxt and not the current.
        /// </summary>
        /// <returns>The size of the actual Text.</returns>
        public override Vector2 MeasureActualSize()
        {
            return Font.MeasureString(maxNumber + "") * Scale;
        }
