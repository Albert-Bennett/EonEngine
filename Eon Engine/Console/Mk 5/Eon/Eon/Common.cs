    ...
    public sealed class Common
    {
        ...
        static void _ChangeScreenSize(Vector2 screenSize)
        {
            if (deviceManager.GraphicsDevice.Adapter.CurrentDisplayMode.Width < (int)screenSize.X ||
                deviceManager.GraphicsDevice.Adapter.CurrentDisplayMode.Height < (int)screenSize.Y)
            {
                if (deviceManager.GraphicsDevice.Adapter.CurrentDisplayMode.Width < (int)screenSize.X)
                {
                ...
                if (deviceManager.GraphicsDevice.Adapter.CurrentDisplayMode.Height < (int)screenSize.Y)
                {
