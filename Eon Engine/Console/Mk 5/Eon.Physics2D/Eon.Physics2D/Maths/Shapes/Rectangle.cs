...
namespace Eon.Physics2D.Maths.Shapes
{
    ...
    public sealed class Rectangle : ConvexShape
    {
        ...
        /// <summary>
        /// Creates a new Rectangle from an Xna rectangle.
        /// </summary>
        /// <param name="rectangle">The Xna rectangle to be used.</param>
        /// <returns>The new Rectangle.</returns>
        public static Rectangle FromRectangle(Microsoft.Xna.Framework.Rectangle rectangle)
        {
