...
namespace Eon.Rendering3D.Culling
{
    ...
    /// </summary>
    public struct ViewClipShape : IContainPoints
    {
        #region Fields
        ...
        /// <summary>
        /// The amount of points that make 
        /// up the ViewClipShape.
        /// </summary>
        public int Count
        {
            get { return count; }
        ...
        /// <returns>The created ViewClipShape.</returns>
        public static ViewClipShape FromPoints(Vector2 point1, Vector2 point2,
