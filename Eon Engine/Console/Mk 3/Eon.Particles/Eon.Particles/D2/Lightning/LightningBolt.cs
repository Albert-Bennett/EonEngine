...
namespace Eon.Particles.D2.Lightning
{
    ...
    public sealed class LightningBolt : IDrawItem
    {
        ...
        /// <param name="generateRate">The lenght of time it takes to generate a line segment.</param>
        ...
        public void Update()
        {
            ...
            else if (generating)
            {
                ...
                if (currentTime >= genTime)
                {
                    ...
                    if (lineSegments.Length == positions.Length - 1)
                        generating = false;
                }
            }
            else
                ...
                case DrawingStage.Colour:
                    {
                        ...
                        {
                            Vector2 direct = lineSegments[i].Direction();
                            Vector2 scale = new Vector2(direct.Length(), thickness);
