...
namespace Eon.Animation2D.SpriteSheet
{
    ...
    /// </summary>
    public sealed class AnimatedSprite : ObjectComponent, IDrawItem, IUpdate
    {
        #region Varibles
            ...
            : base(id)
        {
            ...
            spriteSheet = SerializationHelper.Deserialize<SpriteSheet>(
        ...
        public void Play(bool randomStart)
        {
            if (spriteSheet.TotalFrames > 1)
            {
                ...
                new Error("Total Frames <= 1, unable to play animation.", Seriousness.Warning);
        }
        ...
        public void Draw(DrawingStage stage)
        {
            switch (stage)
            {
                ...
                case DrawingStage.Distortion:
                    Common.Batch.Draw(spriteSheet.DistortionMap, rect, sourceRect,
