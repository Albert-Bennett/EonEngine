...
namespace Eon.Rendering3D.Primatives
{
    ...
    public sealed class LODSphere : BaseLOD
    {
        ...
        /// Creates a new LODSphere.
        /// </summary>
        /// <param name="sphere">The bounding sphere to use in the construction of the LODSphere.</param>
        /// <param name="colour">The colour of the LODSphere.</param>
        public LODSphere(BoundingSphere sphere, Color colour)
            : base(Matrix.CreateScale(sphere.Radius) * 
