...
{
    /// <summary>
    /// Used to define a helper of vertex based calculations.
    /// </summary>
    public sealed class VertexHelper
    {
        ...
        public static Vector3 CalculateTangent(ref VertexPositionTangent vertex1,
            ref VertexPositionTangent vertex2, ref VertexPositionTangent vertex3, ref Vector3 normal)
        {
