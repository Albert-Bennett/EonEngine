...
namespace Eon.PostProcessing.Effects
{
    ...
    public sealed class OverlayEffect : PostProcess
    {
        ...
        public OverlayEffect(PostProcessingLocal activeStore, Color colour) :
            base("OverlayPP", 8, activeStore)
        {
        ...
        public OverlayEffect(PostProcessingLocal activeStore, Texture2D texture) :
            base("OverlayPP", 8, activeStore)
        {
        ...
        public OverlayEffect(PostProcessingLocal activeStore, string textureFilepath) :
            base("OverlayPP", 8, activeStore)
        {
            try
            {
