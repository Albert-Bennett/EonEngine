...
namespace Rendering3DTransparencyFR
{
    public class Testing1 : GameObject
    {
        ...
        protected override void Initialize()
        {
            ...
            p1 = new PointLight(ID + "PointLight1", new Vector3(-1, 0, 0), Color.Aqua.ToVector3(), 1, 3f);
            AttachComponent(p1);

            p2 = new PointLight(ID + "PointLight2", new Vector3(0, 0.8f, 0), Color.Blue.ToVector3(), 1, 3f);
            AttachComponent(p2);

            p3 = new PointLight(ID + "PointLight3", new Vector3(0, -1, 0), Color.White.ToVector3(), 1, 3f);
            AttachComponent(p3);
