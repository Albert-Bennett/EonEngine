...
namespace MK4Update
{
    public class Testing : GameObject
    {
        ...
        {
            camera = new ChaseCamera("Cam1", 0.05f, 50, new Vector3(0, 0.10f, -0.1f),
            ...
            spot = new SpotLight(ID + "Spot1", new Vector3(0.0f, 0.07f, 0.0f),
                ...
                new Vector3(1.0f, 0.0f, 0.0f), 60, 70, 0.9f);
        ...
        protected override void Update()
        {
            ...
            if (b != bias)
            {
                ...
                EngineModuleManager.Find("RenderManager3D").SendMessage("ChangeBias", bias);
            }
