...
namespace Eon.Rendering2D.Cameras
{
    ...
    {
        static List<BaseCamera> cameras =
            new List<BaseCamera>();
        ...
        /// </summary>
        public CameraManager() : base("Camera2DManager") { }

        internal static void AddCamera(BaseCamera camera)
        {
            cameras.Add(camera);
        }
        ...
        /// <summary>
        /// Used to change the limitations of the cameras 
        /// to ones releative to the new screen size.
        /// </summary>
