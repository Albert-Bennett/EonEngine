...
namespace Eon.Particles2D.Types
{
    ...
    public sealed class SimpleSprite : IParticleType
    {
        ...
        public SimpleSprite(string textureFilepath) : this(textureFilepath, "None", "None") { }
        ...
        public SimpleSprite(string textureFilepath, string normalMapFilepath) :
            this(textureFilepath, normalMapFilepath, "None") { }
