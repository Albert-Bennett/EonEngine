...
namespace Eon.Particles2D.Cycles
{
    ...
    public sealed class RandomCycle : Cycle
    {
        ...
        public RandomCycle(TimeSpan minTime, TimeSpan maxTime,
            int totalToBeSpawned, int minSpawnAmount, int maxSpawnAmount)
            : base(TimeSpan.Zero, totalToBeSpawned, 0)
        {
            ...
            timer = TimeSpan.FromSeconds(RandomHelper.GetRandomFloat(
        ...
        protected override void DetermineNext()
        {
            ...
            spawnAmount = RandomHelper.GetRandomInt(minSpawnAmount, maxSpawnAmount);
        }
    }
}
