...
namespace Eon.Animation2D.Skeletal.Blending
{
    ...
    internal sealed class Blender
    {
        ...
        public Blender(TimeSpan blendTime, LimbAnimationState[] prevAnimations,
            LimbAnimationState[] nextAnimations)
        {
            Reset(blendTime, prevAnimations, nextAnimations);
        }

        internal void Reset(TimeSpan blendTime, LimbAnimationState[] prevAnimations,
            LimbAnimationState[] nextAnimations)
        {
            maxTime = blendTime;
        ...
        LimbAnimationState CreateKeyFrame(int index)
        {
            ...
            int totalFrames = (int)(prevAnimations[index].Animation.FrameRate.TotalSeconds / maxTime.TotalSeconds) + 1;
            ...
            frames.FrameRate = TimeSpan.FromSeconds(maxTime.TotalSeconds / totalFrames);
